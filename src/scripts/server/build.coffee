...
wrench.copyDirSyncRecursive('public/shaders', 'src/shaders')
wrench.copyDirSyncRecursive('public/assets_website', 'dist/assets_website')
...
wrench.copyDirSyncRecursive('public/audio', 'dist/audio')
wrench.copyDirSyncRecursive('public/textures', 'dist/textures')
...
config =
  ...
  #optimize: 'none'
  stubModules: ['cs']
  exclude: ['coffee-script', 'socket.io']
  pragmasOnSave:
...
requirejs.optimize config, (buildResponse) ->
  # Done
  wrench.rmdirSyncRecursive('src/shaders', true)
